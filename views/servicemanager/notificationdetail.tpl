		...
		<div class="row">
			...
			<div class="col-md-9" >
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title" id="h3"><i class="fa  fa-calendar-minus-o"></i> 通知详情</h3>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
						<div class="form-group">
							<label for="RECEIVERID">发送人</label>
							<input class="form-control" id="RECEIVERID">
						</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<textarea id="CONTENT" class="form-control" style="height: 100px">
