...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="row">
			<div class="col-md-3">
				<a href="mailbox.html" class="btn btn-primary btn-block margin-bottom">回到通知栏</a>
				...
				<div class="box box-solid">
					...
					<div class="box-body no-padding">
						<ul class="nav nav-pills nav-stacked">
							<li><a href="mailbox.html"><i class="fa fa-inbox"></i> 通知栏
                  <span class="label label-primary pull-right">12</span></a></li>
							<li><a href="#"><i class="fa fa-envelope-o"></i> 发送</a></li>
							<li><a href="#"><i class="fa fa-file-text-o"></i> 草稿箱</a></li>
							<li><a href="#"><i class="fa fa-filter"></i> 垃圾站 <span class="label label-warning pull-right">65</span></a>
							</li>
