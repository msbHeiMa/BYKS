						...
						<div class="modal-body">
							<form class="form-horizontal">
								<div class="box-body">
									...
									<div class="form-group">
										<label for="LOCALADDRESS" class="col-sm-3 control-label">本地地址：</label>
										<div class="col-sm-8">
											<input type="text" class="form-control" id="LOCALADDRESS">
										</div>
									</div>
									<div class="form-group">
										<label for="HEADERPARAM" class="col-sm-3 control-label">缓存类型：</label>
										<div class="col-sm-8">
											<input type="text" class="form-control" id="HEADERPARAM">
										</div>
									</div>
								</div>
								<!-- /.box-body -->
								<div class="box-footer">
									<center><button type="submit" class="btn btn-info" style="margin-left:20px" onclick="addapp()">保存</button>
...
<script type="text/javascript" src="js/staticresource.js"></script>
