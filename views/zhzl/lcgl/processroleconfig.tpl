{% extends '../parent/layout.tpl' %} {% block title %}流程管理{%endblock%} {% block body %}class="hold-transition skin-blue sidebar-collapse
...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<div id="toolbar">
			&nbsp <button id="" class="btn btn-primary" onclick="location.href='addprocessroleconfig.html'" >&nbsp&nbsp新&nbsp&nbsp增&nbsp&nbsp节&nbsp&nbsp点&nbsp&nbsp角&nbsp&nbsp色&nbsp&nbsp配&nbsp&nbsp置</button>	
		</div>
...
<script type="text/javascript" src="js/processroleconfig.js"></script>
 {% endblock %}