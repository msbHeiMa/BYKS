...
{% block title %}功能模块流程业务配置{%endblock%} 
{% block style %} 
<style>
    body{
...
<div class="content-wrapper">
    ...
    <div id="add" is="bs-pop" type="mg" title="功能模块流程业务配置-新增配置" ref="pop" >
		<div ref="alert"></div>
    ...
    <div id="edit" is="bs-pop" type="mg" title="功能模块流程业务管理-编辑配置" ref="pop" >
		<div ref="alert"></div>
		<div class="form-horizontal form-group-sm">
			<cig-form :fields="fields" data-path="info"  ref="form">
			</cig-form>
    ...
    <div id="success" is="bs-pop" type="mg"  ref="pop" >
		<div ref="alert"></div>
		<div class="form-horizontal form-group-mg">
...
<script type="text/javascript">
    var curModule = "日常管理/流程管理/功能模块配置";
    requirejs([
        '{{static}}zhzl/lcgl/js/busiconfig.js'], function () {
    });
</script>
{% endblock %}