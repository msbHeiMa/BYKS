...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<div id="toolbar">
			&nbsp <button id="" class="btn btn-primary" onclick="location.href='addbusiconfig.html'" >&nbsp&nbsp新&nbsp&nbsp增&nbsp&nbsp配&nbsp&nbsp置</button>	
		</div>
...
<script type="text/javascript" src="js/busiconfig.js"></script>
 {% endblock %}