{% extends '../parent/layout.tpl' %} {% block title %}移除{%endblock%} {% block body %}class="hold-transition skin-blue sidebar-collapse
...
<div class="content-wrapper" style="height:750px">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="peopleList.html"> 回访记录</a></li>
...
<div class="col-md-12">
 <center style="margin-top:50px">
		<button id="healing" class="btn btn-success" onclick="healing()" >&nbsp治&nbsp愈&nbsp</button>&nbsp&nbsp&nbsp
	    <button id="die" class="btn btn-success" onclick="died()" >&nbsp死&nbsp亡&nbsp</button>&nbsp&nbsp&nbsp
		<button id="emigrant" class="btn btn-success" onclick="outOfCounty()" >迁&nbsp出&nbsp县&nbsp域</button>&nbsp&nbsp&nbsp
		<button id="reback" class="btn btn-danger" onclick="window.location.href='peopleList.html'">&nbsp返&nbsp回&nbsp</button>&nbsp
 </center></div>
</div>
