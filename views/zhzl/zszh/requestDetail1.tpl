{% extends '../parent/layoutvue.tpl' %} {% block title %}审核详情{%endblock%} {% block style %}{% endblock %} {% block body %}
...
<div class="content-wrapper">
    ...
    <!--<section class="content-header">
        <ol class="breadcrumb">
            <li><a href="request.html"> 我的审核</a></li>
            <li class="active"> 详情
            </li>
        </ol>
    </section>-->
...
<script type="text/javascript">
    ...
    requirejs([
        '{{static}}zhzl/zszh/js/requestDetail1.js'], function () {
    });
</script> {% endblock %}