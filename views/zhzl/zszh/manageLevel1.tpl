{% extends '../parent/layoutvue.tpl' %} {% block title %}管理等级变更{%endblock%} {% block style %}{% endblock %} {% block body
%} {%endblock%} {% block content %}
<!--引用样式-->
<!--<link rel="stylesheet" href="/zhzl/zszh/css/style.css" />-->
<link rel="stylesheet" href="./css/artDialog-5.0.3/skins/opera.css">
		...
		<div id="detail" class="bg-white detail-stage">
			...
			<div class="btn-footer">
				<center>
					...
					<button type="button" class="btn btn-default" @click="dialog">关闭</button>
				</center>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
    ...
    requirejs([
        '{{static}}zhzl/zszh/js/manageLevel1.js',
		 '{{static}}zhzl/zszh/css/artDialog-5.0.3/artDialog.min.js'], function () {
    });
</script> {% endblock %}