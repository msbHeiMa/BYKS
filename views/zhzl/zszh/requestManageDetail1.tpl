{% extends '../parent/layoutvue.tpl' %} {% block title %}管理等级变更审核详情{%endblock%} {% block style %}{% endblock %} {% block
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            <li><a href="requestManage1.html"> 管理性评估等级变更审核</a></li>
            <li class="active"> 详情
            </li>
        </ol>
    </section>
...
<script type="text/javascript">
    var curModule = "人口管理/特殊人群/肇事肇祸精神病/管理等级变更审核详情"+(zhzlconfig.getQueryParams().module || "管理等级变更审核详情");
    requirejs([
        '{{static}}zhzl/zszh/js/requestManageDetail1.js'], function () {
    });
</script> {% endblock %}