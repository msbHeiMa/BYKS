...
<body>
		...
		<nav class="navbar navbar-inverse">
			<div class="container">
				<ul class="navUl">
					...
					<!--<li class="loginBtn" v-if="'{{indexhtml}}'!='index.html'"><a href="/cigWeb/afterLogin.html" class="loginBg"><b class="loginImg" @click="loginUsername"></b></a></li>-->
			...
			<nav class="navbar navbar-inverse">
				<div class="container">
					<ul class="navUl">
						...
						<!--<li class="loginBtn"><a href="/cigWeb/afterLogin.html" class="loginBg"><b class="loginImg"></b></a></li>-->
						<!--<li class="loginBtn" v-if="'{{indexhtml}}'=='index.html'"><a href="/cigWeb/afterLogin.html"><b class="loginImg"></b></a></li>-->
						<li class="loginBtn">你好！{{userName}}</li>
					</ul>
				</div>
			</nav>
    ...
    requirejs([
        '/cigWeb/parent/header.js'], function () {
    });
