...
$(document).ready(function () {
     $.ajax({
        ...
        type: "GET",
        url: restconfig.resturl + "zszh-temp/listPsmPersonNameAndCardNumber?departId=282402504704&queryName=%E8%8B%97",
        dataType: 'json',
...
function getuser() {
    $.ajax({
        ...
        type: "GET",
        data: "",
        url: "http://192.168.3.231/a4service/webservice/tokenservice.asmx/GetTokenInfo?token=" + num,
        dataType: 'xml',
