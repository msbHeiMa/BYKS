        ...
        data: {
            ...
            fields: {
                main: [
                    ...
                    { label: "目前管理等级", name: "manageLevel", type: "display", domainName: "manageLevel", colSpan: 1 },
                    { label: "危险性评估等级", name: "dangerRank", type: "display", domainName: "dangerRank", colSpan: 1 },
                    { label: "申请管理等级", name: "finalLevel", options: [{ text: "一级管理", value: 1 }, { text: "二级管理", value: 2 }, { text: "三级管理", value: 3 }, { text: "四级管理", value: 4 }], type: "selected", colSpan: 1 },
            ...
            columns: {
                ...
                "record": [
                    ...
                    },
                    {
                        ...
                        valign: 'middle',
                        visible: true,
                        component: tableHelper.getDomainDisplayComponent("isMedication", "isCTrouble")
                    },
                    {
                        title: '是否存在危害行为',
        ...
        methods: {
            ...
            beforSave: function () {
                ...
                $.ajax({
                    ...
                    data: {
                        "JSBId": this.JSBId,
                        "originalLevel": this.mainInfo.manageLevel,
