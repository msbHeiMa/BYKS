define([
    ...
    var detailVm = new Vue({
        ...
        data: {
            ...
            fields: {
                main: [
                    ...
                    { label: "目前随访周期", name: "visitCyc", type: "display", colSpan: 1 },
                    { label: "申请随访周期", name: "finalCyc", type: "text", colSpan: 1 },
        ...
        methods: {
            ...
            loadTabs: function () {
                var options = {
                    "url": systemConfig.backendurl + "/zszh/listMessageForRevisitCycSetting",
                    data: {
                        JSBId: this.JSBId
                    },
                    type: "get",
            ...
            beforSave: function () {
                $.ajax({
                    ...
                    data: {
                        "JSBId": this.JSBId,
                        "originalCyc": this.mainInfo.visitCyc,
                        "finalCyc": this.mainInfo.finalCyc,
